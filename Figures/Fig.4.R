...
# Fig.4G-H Pathway analysis - Import the 'ALL DEG files.RData' file (supplemental data from original publication) into the R Studio environment
...
# Figure 4G - barplot of DCT1-enriched pathway
...
# Figure 4H - barplot of DCT2-enriched pathway
